...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'aaldwairi';//this will be your WCC username
      $dbUsr = 'aaldwairi';//this will be your WCC username
      $dbPass = 'bURRQa7GFGhD';//this will be the password found in the video.
